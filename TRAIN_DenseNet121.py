...
from DenseNet121 import model, train_function, validate_function, criterion, optimizer 
...
torch.save(model.state_dict(), "densenet121_fish_classifier_15epochs.pth")
